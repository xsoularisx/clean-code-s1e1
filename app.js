...
var editTask = function () {
  ...
  var containsClass = listItem.classList.contains("edit__tasks");

  //If class of the parent is .edit__tasks
  if (containsClass) {
    //switch to .edit__tasks
  ...
  //toggle .edit__tasks on the parent.
  listItem.classList.toggle("edit__tasks");
};
